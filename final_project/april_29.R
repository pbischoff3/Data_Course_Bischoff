...
# Read in data 
df <- readxl::read_excel("../../pbischoff3.github.io/Data/Medical Conditions and Science Motivation Data 3.4.22.xlsx")
df <- df %>% 
  janitor::clean_names()
df <- df %>% 
...
compare_performance(si_mod_1,si_mod_2,si_mod_3,si_mod_4) # major and career look best, with highest r2 and rmse and lowest aic and bic
